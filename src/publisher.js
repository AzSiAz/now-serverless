...
const requestData$ = async (requestUrl) => {
    ...
    const url = `https://www.novelupdates.com/${params.english ? "epublisher" : "opublisher"}/${params.slug}/?pg=${params.page}`
...
module.exports = async (req, res) => {
    try {
        ...
        const data = extractPublisherData($)
