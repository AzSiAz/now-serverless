...
const { extractSlug, authorRegex } = require("./utils/extractSlug")
...
const extractNovelTypeListData = ($) => {
    return $("div.wpb_wrapper > ul > li").map((i, el) => {
        ...
        return {
            ...
            slug: extractSlug(element.find("a").attr("href"), authorRegex),
...
const requestData$ = async (requestUrl) => {
    ...
    const url = `https://www.novelupdates.com/list-authors/?pg=${params.page}`
